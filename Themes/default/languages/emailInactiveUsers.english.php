...
$txt['eiu_desc'] = ' This is your main admin panel for the email inactive users mod. <br/> This mod will add a scheduled task where users who haven\'t been active in x days will be sen\'t an customizable email, a second check will be performed, if the user still hasn\'t been logged in yet, the mod will delete the account.<br /> The mod uses the mail queue, if you have a large mail queue it is advisable to set a large number of days to wait before deletion, this is because the deletion time period is set the day the scheduled task is executed, not the day the actual mail was sent.';
$txt['eiu_inactiveFor'] = 'How many days has passed since their last log in';
