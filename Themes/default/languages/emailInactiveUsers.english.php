...
$txt['eiu_eiu_posts'] = 'Minimum posts made';
$txt['eiu_eiu_posts_sub'] = 'The number of posts the user made, if an user has more posts than this limit (s)he won\'t be considered by the mod.<br />If left empty, the mod will use the default value: 5.';
