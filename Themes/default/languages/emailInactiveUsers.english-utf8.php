...
$txt['eiu_desc'] = ' This is your main admin panel for the email inactive users mod. <br/> This mod will add a scheduled task where users who haven\'t been active in x days will be sent a customizable email and the user will be placed in the "to delete" list, the admin then proceed to mark them for deletion, the user will be deleted after x days has passed since marked for deletion, you can configure how many days.<br /> The mod uses the mail queue, if you have a large mail queue it is advisable to set a large number of days to wait before deletion, this is because the deletion time period starts to count after the admin has set an account for deletion and not after the main was sent so its possible that the account will be deleted before getting the mail.<br /> The "don\'t delete" option allows you to permanently remove an user from getting deleted by this mod even if the user complies with all the other requirements.<br />User marked for deletion will appear on another list, the list will inform when the deletion will be performed.';
